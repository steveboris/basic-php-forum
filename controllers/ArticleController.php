...
class ArticleController extends Controller
{
    ...
    {
        return [
            [ /*this help to disable the accessing page by typing the path on the url*/
                'class' => AccessControl::class,
                'only' => ['create', 'update', 'delete'], /*Reject this action if the user is not authenticated */
                'rules'=> [
                    [
    ...
    {
        /*Has be modified so that the non owner of a post can not delete the post*/
        $model = $this->findModel($slug);
